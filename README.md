...
| [`data_BBCA_bulanan.csv`](data_BBCA_bulanan.csv) | Data mentah: harga penutupan bulanan saham BBCA, Jan 2023 sampai Agu 2026 (44 observasi), dari Tugas 1. |
...
- **First difference**-nya berperilaku seperti white noise, jadi data konsisten sebagai **Random Walk**.
