...
- `Tugas_2_ADT_BBCA.ipynb`: notebook tugas yang dikumpulkan. Menggunakan data dari Tugas 1 (`data_BBCA_bulanan.csv`, harga penutupan bulanan saham BBCA periode 2023-2026).
